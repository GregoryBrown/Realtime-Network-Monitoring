...
import mdt_grpc_dialin_pb2 as mdt__grpc__dialin__pb2
...
class gRPCConfigOperStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetConfig = channel.unary_stream(
        ...
        request_serializer=mdt__grpc__dialin__pb2.ConfigGetArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.ConfigGetReply.FromString,
        )
    self.MergeConfig = channel.unary_unary(
        '/IOSXRExtensibleManagabilityService.gRPCConfigOper/MergeConfig',
        request_serializer=mdt__grpc__dialin__pb2.ConfigArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.ConfigReply.FromString,
        )
    ...
    self.CliConfig = channel.unary_unary(
        ...
        request_serializer=mdt__grpc__dialin__pb2.CliConfigArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.CliConfigReply.FromString,
        )
    self.CommitReplace = channel.unary_unary(
        '/IOSXRExtensibleManagabilityService.gRPCConfigOper/CommitReplace',
        request_serializer=mdt__grpc__dialin__pb2.CommitReplaceArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.CommitReplaceReply.FromString,
        )
    self.CommitConfig = channel.unary_unary(
        '/IOSXRExtensibleManagabilityService.gRPCConfigOper/CommitConfig',
        request_serializer=mdt__grpc__dialin__pb2.CommitArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.CommitReply.FromString,
        )
    self.ConfigDiscardChanges = channel.unary_unary(
        '/IOSXRExtensibleManagabilityService.gRPCConfigOper/ConfigDiscardChanges',
        request_serializer=mdt__grpc__dialin__pb2.DiscardChangesArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.DiscardChangesReply.FromString,
        )
    self.GetOper = channel.unary_stream(
        '/IOSXRExtensibleManagabilityService.gRPCConfigOper/GetOper',
        request_serializer=mdt__grpc__dialin__pb2.GetOperArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.GetOperReply.FromString,
        )
    self.CreateSubs = channel.unary_stream(
        '/IOSXRExtensibleManagabilityService.gRPCConfigOper/CreateSubs',
        request_serializer=mdt__grpc__dialin__pb2.CreateSubsArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.CreateSubsReply.FromString,
        )
...
def add_gRPCConfigOperServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetConfig': grpc.unary_stream_rpc_method_handler(
          servicer.GetConfig,
          request_deserializer=mdt__grpc__dialin__pb2.ConfigGetArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.ConfigGetReply.SerializeToString,
      ),
      'MergeConfig': grpc.unary_unary_rpc_method_handler(
          servicer.MergeConfig,
          request_deserializer=mdt__grpc__dialin__pb2.ConfigArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.ConfigReply.SerializeToString,
      ),
      ...
      'CliConfig': grpc.unary_unary_rpc_method_handler(
          servicer.CliConfig,
          request_deserializer=mdt__grpc__dialin__pb2.CliConfigArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.CliConfigReply.SerializeToString,
      ),
      'CommitReplace': grpc.unary_unary_rpc_method_handler(
          servicer.CommitReplace,
          request_deserializer=mdt__grpc__dialin__pb2.CommitReplaceArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.CommitReplaceReply.SerializeToString,
      ),
      'CommitConfig': grpc.unary_unary_rpc_method_handler(
          servicer.CommitConfig,
          request_deserializer=mdt__grpc__dialin__pb2.CommitArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.CommitReply.SerializeToString,
      ),
      'ConfigDiscardChanges': grpc.unary_unary_rpc_method_handler(
          servicer.ConfigDiscardChanges,
          request_deserializer=mdt__grpc__dialin__pb2.DiscardChangesArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.DiscardChangesReply.SerializeToString,
      ),
      'GetOper': grpc.unary_stream_rpc_method_handler(
          servicer.GetOper,
          request_deserializer=mdt__grpc__dialin__pb2.GetOperArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.GetOperReply.SerializeToString,
      ),
      'CreateSubs': grpc.unary_stream_rpc_method_handler(
          servicer.CreateSubs,
          request_deserializer=mdt__grpc__dialin__pb2.CreateSubsArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.CreateSubsReply.SerializeToString,
      ),
  }
...
class gRPCExecStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ShowCmdTextOutput = channel.unary_stream(
        ...
        request_serializer=mdt__grpc__dialin__pb2.ShowCmdArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.ShowCmdTextReply.FromString,
        )
    self.ShowCmdJSONOutput = channel.unary_stream(
        '/IOSXRExtensibleManagabilityService.gRPCExec/ShowCmdJSONOutput',
        request_serializer=mdt__grpc__dialin__pb2.ShowCmdArgs.SerializeToString,
        response_deserializer=mdt__grpc__dialin__pb2.ShowCmdJSONReply.FromString,
        )
...
def add_gRPCExecServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ShowCmdTextOutput': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=mdt__grpc__dialin__pb2.ShowCmdArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.ShowCmdTextReply.SerializeToString,
      ),
      'ShowCmdJSONOutput': grpc.unary_stream_rpc_method_handler(
          servicer.ShowCmdJSONOutput,
          request_deserializer=mdt__grpc__dialin__pb2.ShowCmdArgs.FromString,
          response_serializer=mdt__grpc__dialin__pb2.ShowCmdJSONReply.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
