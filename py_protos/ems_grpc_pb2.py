...
ActionJSONArgs = _reflection.GeneratedProtocolMessageType('ActionJSONArgs', (_message.Message,), dict(
...
ActionJSONReply = _reflection.GeneratedProtocolMessageType('ActionJSONReply', (_message.Message,), dict(
