...
# source: cisco_mdt_dial_out.proto
...
_MDTDIALOUTARGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ReqId",
            full_name="mdt_dialout.MdtDialoutArgs.ReqId",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="data",
            full_name="mdt_dialout.MdtDialoutArgs.data",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="errors",
            full_name="mdt_dialout.MdtDialoutArgs.errors",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
MdtDialoutArgs = _reflection.GeneratedProtocolMessageType(
    "MdtDialoutArgs",
    (_message.Message,),
    {
        "DESCRIPTOR": _MDTDIALOUTARGS,
        "__module__": "cisco_mdt_dial_out_pb2"
